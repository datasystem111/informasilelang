  ...
  <div class="tabel">
    <table border="1" cellpadding="10" cellspacing="0" width="100%">
		<tr>
			...
			<th width="11%">Status Surduk</th>
			<th>Tenaga Ahli</th>
			<th>Status Klarifikasi</th>
			<th width="9%">Tanggal Submit</th>
			<th width="20%">Link Gdrive</th>
			<th width="9%">Aksi</th>
		</tr>
		<?php $i = 1; ?>
		...
		<tr>
			...
			<td><?= $row ["namaPokja"]; ?></td>
			<td><?= $row ["statusSurduk"]; ?></td>
			<td class="tengah"><?= $row ["tenagaAhli"]; ?></td>
			<td><?= $row ["statusKlarifikasi"]; ?></td>
			<td class="tengah"><?= $row ["tanggalSubmit"]; ?></td>
			<td><a href="<?= $row ["gdrive"]; ?>"><?= $row ["gdrive"]; ?></a></td>
			<td class="tengah">
